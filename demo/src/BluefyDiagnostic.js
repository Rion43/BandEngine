...
let lastWriteTime = 0;
let seqCounter = 0;
let gattServerPtr = null;
export function diagInit(gatt) {
    gattServerPtr = gatt;
    writeLogs = [];
    disconnectTime = 0;
    lastWriteTime = 0;
...
export function setGattPtr(gatt) {
    gattServerPtr = gatt;
}
export function diagGetWriteTable() {
...
export async function diagWriteDebug(writeFn, uuid, bytes, opcode) {
