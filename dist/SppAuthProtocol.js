...
import { encodeCommandPhoneNonce, encodeCommandAuthStep3, encodeAuthDeviceInfo, encodeAuthStep3Payload, decodeWatchNonce, decodeAuthResponse, toHex as msgHex, } from './SppAuthMessages.js';
import { computeAuthStep3Hmac, aesCcmEncrypt, aesCtrEncrypt, aesCtrDecrypt, computeEncryptedNonces, verifyWatchHmac, } from './SppAuthCrypto.js';
export class SppAuthProtocol {
     ...
     */
    async processWatchNonce(watchPayload) {
        if (!this._phoneNonce) {
     ...
     */
    processAuthResponse(authPayload) {
